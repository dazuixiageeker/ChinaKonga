...
public class ParaController {
    ...
    public Result<List<Para>> list(@PathVariable(value = "categoryId")Integer categoryId){
        List<Para> paras = paraService.findParasByCategoryId(categoryId);
        return new Result<List<Para>>(true,StatusCode.OK,"根据分类ID查询参数成功",paras);
