...
public class CategoryController {
     ...
     */
    @GetMapping("/list/{id}")
    public Result<List<Category>> findListByParentId(@PathVariable("id") Integer id){
        List<Category> list = categoryService.findListByParentId(id);
        return new Result<List<Category>>(true, StatusCode.OK,"商品分类表查询成功",list);
    }
}
