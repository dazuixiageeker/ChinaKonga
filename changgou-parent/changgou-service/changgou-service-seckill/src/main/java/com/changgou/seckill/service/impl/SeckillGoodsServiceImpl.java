...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public SeckillGoods getDetail(String time, Long id) {
        SeckillGoods  seckillGoods= (SeckillGoods) redisTemplate.boundHashOps("SeckillGoods_" + time).get(String.valueOf(id));
        return seckillGoods;
    }
