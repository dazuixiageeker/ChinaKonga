...
public class SeckillOrderController {
    ...
    public Result placeOrder(String time, Long seckillId, String username){
        try {
            Boolean orderBool = seckillOrderService.placeOrder(time, seckillId, username);
            if(orderBool){
        ...
        return new Result(false, StatusCode.NOTFOUNDERROR,"该商品已售罄");
    }
